...
public class Generator extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.drawer_generator);
                        ...
                        if (etx_unit.getText().toString().length() == 0) {
                            ...
                            if (etx_description_address.getText().toString().length() == 0) {
                                Snacky.builder()
                                    ...
                                    Intent generator_intent = new Intent(Generator.this, Time.class);
                                    startActivity(generator_intent);
                                }
                            }
                        }
                    }
    ...
    public void generatorplaces() {
        ...
        spn_place.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                generatorplaceText = parent.getItemAtPosition(position).toString();
            }
            @Override
