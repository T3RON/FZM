...
public class Wiring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.drawer_wiring);
                        ...
                        if (etx_plaque.getText().toString().length() == 0) {
                            ...
                            if (etx_unit.getText().toString().length() == 0) {
                                ...
                                if (etx_description_address.getText().toString().length() == 0) {
                                    ...
                                    Intent wiring_intent = new Intent(Wiring.this, Time.class);
                                    startActivity(wiring_intent);
                                }
                            }
                        }
                    }
    ...
    public void WiringJobs() {
        ...
        spn_job.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                wiringjobText = parent.getItemAtPosition(position).toString();
            }
            @Override
