...
public class Chandelier extends AppCompatActivity {
    ...
    @BindView(R.id.cb_nasb_cheragh) CheckBox cb_nasb_cheragh;
    @BindView(R.id.cb_afzayesh) CheckBox cb_afzayesh;
    @BindView(R.id.cb_taghsim) CheckBox cb_taghsim;
    @BindView(R.id.cb_nasb_chandelier) CheckBox cb_nasb_chandelier;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawerLayout = findViewById(R.id.drawer_chandelier);
                        ...
                        if (etx_plaque.getText().toString().length() == 0) {
                            ...
                            if (etx_unit.getText().toString().length() == 0) {
                                ...
                                if (etx_description_address.getText().toString().length() == 0) {
                                    ...
                                    startActivity(Chandelier_intent);
                                }
                            }
                        }
                    }
